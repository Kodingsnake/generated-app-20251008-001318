  ...
  theme: {
  	extend: {
        ...
        pixel: ['VT323', 'monospace'],
  		...
  		colors: {
        'retro-purple': 'rgb(29, 20, 40)',
        'retro-magenta': 'rgb(255, 0, 157)',
        ...
        glitch: {
          '0%': { textShadow: '1px 0 0 #ff009d, -1px 0 0 #00ffff', transform: 'translate(0)' },
          '20%': { textShadow: '1px 0 0 #ff009d, -1px 0 0 #00ffff', transform: 'translate(-1px)' },
          '40%': { textShadow: '1px 0 0 #ff009d, -1px 0 0 #00ffff', transform: 'translate(1px)' },
          '60%': { textShadow: '3px 0 0 #ff009d, -3px 0 0 #00ffff', transform: 'translate(0)' },
          '80%': { textShadow: '1px 0 0 #ff009d, -1px 0 0 #00ffff', transform: 'translate(0)' },
          '100%': { textShadow: '1px 0 0 #ff009d, -1px 0 0 #00ffff', transform: 'translate(0)' },
        },
  			'fade-in': {
  				'0%': {
  					opacity: '0',
